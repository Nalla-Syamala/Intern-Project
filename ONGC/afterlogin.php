...
<i class="fa fa-reorder" onclick="callsh()" style="cursor:pointer;font-size:24px;margin:10px 2px 0px 20px;color:white"></i>		
		...
		<h3 style="color:lightyellow"><?php echo $fname." ".$lname; ?></h3>
		</div>
		...
		<div id="main" style="width:78%;float:left;" >
			...
			<div class="" id="makecomplaint" style="width:100%;display:none;border-radius:15px;padding:15px;margin:10px;background-color:rgba(32, 76, 5, 0.1);border:1px solid aqua;">
				...
				<form class="form" action="usermakecomp.php" method="POST" style="width:100%;" enctype="multipart/form-data">
					...
					<input type="text" name="subcategory" style="width:30%;border-radius:5px;height:37px; border:.8px solid aqua;" placeholder="Sub Category">
					<br /><br />
					<span id="span2">Nature of Complaint</span><input type="text" name="nature" class="form-control in2" placeholder="Complaint"><br />
					<span id="span">Complaint</span>
					<textarea name="comp" class="form-control in1" placeholder="Secure Complaint" style="height:200px;"></textarea><br />
					<br /><span id="span">Regarding File (If any) Max Size 1Mb</span><input name="f2" type="file" class="form-control" >
				<br />

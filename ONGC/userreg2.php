	...
	if(mysqli_query($conn,$query1))
	{
		...
		if($check==0)
		{
			...
			$chk=mysqli_query($conn,$query);
				...
				if($chk)
				{
					$msg="<h5 style='padding:10px'>Sign Up Successfully! <a href='userlogin1.html'>Login here</a>
		...
		$newname=  generateRandomString();
			...
			$newname5=$uname.generateRandomString();
				...
				$msg="<h4>username ($uname) already exist.Please <a href='userreg1.html'> Try again </a></h4><br />
